# -*- coding: utf-8 -*-
"""
Created on Mon Jul 20 23:05:51 2020

@author: SHARI
"""

#file:Housing_Price_170720_test,impute,capping,onehat encoding,sklearn,VIF
import pandas as pd
import numpy as np
...
#pvalue high means less significance on target value so drop such variable one by one and 
...
x_train_lm_3 = x_train_lm_2.drop(["Garden Facing"], axis=1)
lr_3 = sm.OLS(y_train, x_train_lm_3).fit()
lr_3.params
print(lr_3.summary())

x_test_lm_3 = x_test_lm_2.drop(["Garden Facing"], axis=1)
...
x_train_lm_5 = x_train_lm_4.drop(["Pool Facing"], axis=1)
lr_5 = sm.OLS(y_train, x_train_lm_5).fit()
lr_5.params
print(lr_5.summary())


x_test_lm_5 = x_test_lm_4.drop(["Pool Facing"], axis=1)
...
y_pred_test_lm_6 = lr_6.predict(x_test_lm_6)
r2_test_6 = r2_score(y_test, y_pred_test_lm_6)