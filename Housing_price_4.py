# -*- coding: utf-8 -*-
"""
Created on Thu Oct 22 17:41:24 2020

@author: windows
"""

#DataSet: Housing Price
#impute Nan,Capping outlier ,OneHat Encoding
import pandas as pd
import numpy as np
...
x_train_lm_5=x_train_lm_4.drop(['No Special Feature'],axis=1)
lr_5=sm.OLS(y_train,x_train_lm_5).fit()
lr_5.params
lr_5.summary()

x_test_lm_5=x_test_lm_4.drop(['No Special Feature'],axis=1)
